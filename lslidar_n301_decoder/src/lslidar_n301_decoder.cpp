...
bool LslidarN301Decoder::loadParameters() {
  ...
  pnh.param<string>("lslidar_packet", lslidar_packet, "lslidar_packet");
  pnh.param<string>("lslidar_sweep", lslidar_sweep, "lslidar_sweep");
...
void LslidarN301Decoder::publishScan()
{
  ...
  scan->angle_min = -M_PI; //whj
  scan->angle_max = M_PI;//whj
